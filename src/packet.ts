...
class Packet {
    ...
    public transportCode1: number | null;
    public transportCode2: number | null;

    // parsed info
    public route_type: number;
    public route_type_string: string | null;
    public payload_type: number;
    public payload_type_string: string | null;
    public payload_version: number;
    public is_marked_do_not_retransmit: boolean;
    ...
    static fromBytes(bytes: Uint8Array) {
        ...
        const hasTransportCodes =
            ...
            routeType === Packet.ROUTE_TYPE_TRANSPORT_DIRECT;
    ...
    static extractPathHashSize(pathLen: number) {
    ...
    static extractPathHashCount(pathLen: number) {
    ...
    getRouteTypeString() {
        switch (this.getRouteType()) {
            ...
            case Packet.ROUTE_TYPE_DIRECT:
                return "DIRECT";
            case Packet.ROUTE_TYPE_TRANSPORT_FLOOD:
                return "TRANSPORT_FLOOD";
            case Packet.ROUTE_TYPE_TRANSPORT_DIRECT:
